...
const banner2 = cfonts.render((`➤ AGRADECEMOS POR USAR A KIMETSU\nCriador: +55 62 9241-2489\n`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`KIMETSU|BOT`), {
  font: 'block',
  align: "center",
  gradient: ['blue', 'blue']
});
...
const authorname = "Two Multi-Device"
const packname = "Criador: blux-md"

const chyt = "556292412489@s.whatsapp.net";
const nit = "556292412489@s.whatsapp.net";
const supre = "556292412489@s.whatsapp.net";
