exports.playResult = (data) => {
  return `${data.resultado[0].title}\n• ${data.resultado[0].timestamp} | ${data.resultado[0].seconds} segundos.\n• *Link:* ${data.resultado[0].url}`
}
